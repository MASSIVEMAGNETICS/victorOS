...
public final class VictorStore implements VictorPhysiology.ReceiptLedger, VictorPhysiology.StatePersistence {
    ...
    public synchronized List<String> verify() {
        ...
        catch (JSONException malformed) { problems.add("Malformed event ledger"); return problems; }
    ...
    @Override public synchronized boolean verifyIntegrity() { return verify().isEmpty(); }

    @Override public synchronized String lastHash() {
        try {
