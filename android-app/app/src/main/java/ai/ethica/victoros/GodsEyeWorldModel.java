...
public final class GodsEyeWorldModel {
    ...
    public static synchronized Observation publishText(Context context,String source,String text,String summary){
        ...
        if(store.load().humanStop)return blocked(source);
    ...
    private static Observation blocked(String source){return new Observation(source,"blocked by HUMAN STOP",VictorStore.sha256("HUMAN_STOP"),0);}
